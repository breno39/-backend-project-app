package com.breno39.backendinterviewproject.service.application.service;
...
public class ServiceSpringDataJPAService implements ServiceService{
    ...
    @Override
    public com.breno39.backendinterviewproject.service.domain.Service addAvailableServiceToDevice(ServiceType type, UUID deviceId) {
        ...
        if(returnedDevice.getServiceByServiceType(type).isEmpty()) {
            var newService = new com.breno39.backendinterviewproject.service.domain.Service(type);
